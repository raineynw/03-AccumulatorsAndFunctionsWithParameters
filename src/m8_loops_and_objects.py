...
def draw_circles1():
    ...
    circ_center = rg.Point(200, 200)
    for k in range(21):
        radius = k*10
        nadia = rg.Circle(circ_center, radius)
...
def draw_circles2():
    ...
    radius = 10
    for k in range(18):
        center = rg.Point((20 * (k + 1) + 30), 100)
        rose = rg.Circle(center, radius)
        rose.fill_color = 'blue'
        rose.attach_to(window)
    window.render()
    window.close_on_mouse_click()
...
def draw_cosines_and_sines():
    ...
    for k in range(101):
        ...
        center = rg.Point(a,b)
        nathan = rg.Circle(center,radius)
        nathan.attach_to(window)
    window.render()
    window.close_on_mouse_click()
